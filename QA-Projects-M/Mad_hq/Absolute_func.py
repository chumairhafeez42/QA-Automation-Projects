...
def cat_img_download_func(img_url,img_name):
    urllib.request.urlretrieve(img_url, "E:\Emsgroup\Mad-hq\Images\categories_images/" + img_name.lower().replace('&','').replace(' ', '').replace('/', '').replace('_','').replace('-','')+".jpg")

def sub_cat_img_download_func(img_url,img_name):
    urllib.request.urlretrieve(img_url, "E:\Emsgroup\Mad-hq\Images\sub_categories_images/" + img_name.replace('&','').replace(' ', '').replace('/', '').replace('_','').replace('-','')+".jpg")

def prod_img_download_func(img_url,img_name):
    urllib.request.urlretrieve(img_url, "E:\Emsgroup\Mad-hq\Images\product_images/" + img_name.lower().replace('&','').replace(' ', '').replace('/', '').replace('_','').replace('-','')+".jpg")

def multi_prod_img_download_func(img_url,img_name,x):
    urllib.request.urlretrieve(img_url, "E:\Emsgroup\CTS\Images\product_images/"+ img_name.lower().replace('&','').replace(' ', '').replace('/', '').replace('_','').replace('-','')+str(x)+".jpg")
