...
def cat_img_download_func(img_url,img_name):
    urllib.request.urlretrieve(img_url, "E:/Emsgroup/beaumonttom/Images/category/" + img_name.lower().replace(' ', '').replace('/', '').replace('_','')+".jpg")
...
def prod_img_download_func(img_url,img_name):
    urllib.request.urlretrieve(img_url, "E:/Emsgroup/beaumonttom/Images/product_images/" + img_name.lower().replace(' ', '').replace('/', '').replace('_','')+".jpg")

def multi_prod_img_download_func(img_url,img_name,x):
    urllib.request.urlretrieve(img_url, "E:/Emsgroup/beaumonttom/Images/product_images/"+ img_name.lower().replace(' ', '').replace('/', '').replace('_','')+str(x)+".jpg")
