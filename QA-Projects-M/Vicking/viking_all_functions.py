...
def cat_data_insertion(sql , val):
    try:
...
def cat_img_download_func(img_url,img_name):
    urllib.request.urlretrieve(img_url, r"E:\Emsgroup\Vicking\Images\category/" + img_name.replace(' ', '').replace('/', '').replace('_','')+".jpg")

def sub_cat_img_download_func(img_url,img_name):
    urllib.request.urlretrieve(img_url, r"E:\Emsgroup\Vicking\Images\sub_category/" + img_name.replace(' ', '').replace('/', '').replace('_','')+".jpg")

def prod_img_download_func(img_url,img_name):
    urllib.request.urlretrieve(img_url, r"E:\Emsgroup\Vicking\Images\product_images/" + img_name.replace(' ', '').replace('/', '').replace('_','').replace('@','')+".jpg")

def multi_prod_img_download_func(img_url,img_name,x):
    urllib.request.urlretrieve(img_url, r"E:\Emsgroup\Vicking\Images\product_images/" + img_name.replace(' ', '').replace('/', '').replace('_','')+str(x)+".jpg")
